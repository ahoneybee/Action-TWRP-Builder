...
| `DEVICE_TREE_URL`    | Device address                                    | https://github.com/ahoneybee/android_device_asus_I005DS      |
| `DEVICE_TREE_BRANCH` | Device branch                                     | android-12.1                                                 |
| `DEVICE_PATH`        | Device location                                   | device/asus/I005DS                                           |
| `COMMON_TREE_URL`    | Common tree address                               | https://github.com/ahoneybee/android_device_asus_sm8350-common |
| `COMMON_PATH`        | Common tree location                              | device/asus/sm8350-common                                    |
| `DEVICE_NAME`        | Model name                                        | I005DS                                                       |
| `MAKEFILE_NAME`      | Makefile name                                     | twrp_I005DS                                                  |
